...
from schemas import (DaySumaryOutput, ErrorOutPut, StandardOutput,
                     UserCreateInput, UserFavoriteAddInput, UserListoutput)
...
# @assets_router.get('/day_summary/{user_id}', response_model=List[DaySumaryOutput], responses={400: {'model': ErrorOutPut}})
